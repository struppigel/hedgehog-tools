...
The very first transpiled layer is the extraction of just the relevant functions which are often buried in > 6000 lines of code. This step allows manual analysis of the initial code, e.g., in case of debugging the script but also to see how the layer works. In case the entry point function for the malware code turns out to be wrong one, you can set it manually, e.g., here for the function named _iolad7_:
